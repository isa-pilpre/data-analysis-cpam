...
departements_top5 = ['Nièvre', 'Allier', 'Moselle', 'Corse-du-Sud', 'Creuse'] # Dépts les plus impactés
departements_bottom5 = ["Mayotte", "Guyane", "La Réunion", "Martinique", "Guadeloupe"]  # Dépts les moins impactés
departements_cibles = departements_top5 + departements_bottom5
cancer_id = "CAN_SEI_CAT"   # Identifiant du cancer du sein
age = "tsage"               # tous âges
sexe = 2                    # exclusivement féminin dans ce dataset
start_year = 2015
end_year = 2022
...
plt.title("Prévalence du cancer du sein dans les départements les plus et les moins affectés, de 2015 à 2022")
