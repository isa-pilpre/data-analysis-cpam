...
# Définir les départements Top 4 et Bottom 4 en 2022 pour "CAN_BPU_CAT"
...
plt.title('Évolution de la prévalence du cancer du poumon dans les départements "Top 4" et "Bottom 4" de 2015 à 2022')
plt.xticks(annees)
plt.grid(True)
plt.tight_layout()
