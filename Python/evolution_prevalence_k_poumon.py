...
departements_top5 = ['Corse-du-Sud', 'Haute-Corse', 'Ardennes', 'Nièvre', 'Ariège'] # Dépts les plus impactés
departements_bottom5 = ["Mayotte", "Guyane", "Guadeloupe", "Martinique", "La Réunion"]  # Dépts les moins impactés
...
plt.title("Prévalence du cancer du poumon dans les départements les plus et les moins affectés, de 2015 à 2022")
